...
<body>
    ...
    <div class="container">
        <div class="navbar-header"><a href="index.php" class="navbar-brand navbar-link"><i class="glyphicon glyphicon-fire text-info"></i>Online Gas Booking</a>
  ...
  <div class="tab-content">
	  ...
	  <br>
        ...
        <div class="carousel slide" data-ride="carousel" id="carousel-1">
            <div class="carousel-inner" role="listbox">
				<div class="item active"><img style=" margin: 0 auto;" src="assets/img/2.jpeg" alt="First Image"></div>
            </div>
    ...
    <footer class="site-footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <h5>Annapoorneswari D © 2021</h5></div>
			</div>
        </div>
    </footer>
